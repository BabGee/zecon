# Generated by Django 3.1.3 on 2021-03-19 11:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sire_name', models.CharField(blank=True, max_length=200, null=True, verbose_name='Nature of breeding')),
                ('sire_origin', models.CharField(blank=True, max_length=200, null=True, verbose_name='Sires name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_history', models.CharField(default='When was the case reported', max_length=100)),
                ('mortality_rate', models.CharField(default='State the mortality rate of the case reported', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('by_veterinary_officer', models.CharField(choices=[('Y', 'yes'), ('N', 'no')], default='Y', max_length=20, verbose_name='Is the farm manged by a veterinary officer or livestock officer?')),
                ('if_no', models.CharField(blank=True, max_length=100, null=True, verbose_name='If no,who is the farm consultant?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('vet_form', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='portals.vet_forms')),
                ('farmer_username', models.CharField(default='', max_length=12, verbose_name='Farmer Username')),
                ('species_operated_on', models.CharField(choices=[('0', 'cattle'), ('1', 'sheep'), ('2', 'goat'), ('3', 'donkey'), ('4', 'dog'), ('5', 'horse'), ('6', 'poultry'), ('7', 'others')], default='0', max_length=20, verbose_name='Animal species naffected')),
                ('sex_of_the_animal', models.CharField(choices=[('M', 'male'), ('F', 'female')], default='M', max_length=20, verbose_name='Sex of the animal')),
                ('name_of_the_animal', models.CharField(blank=True, max_length=30, null=True, verbose_name='Name or identification number')),
                ...
                ('if_other_specify', models.CharField(blank=True, max_length=100, null=True, verbose_name=True)),
                ('operation_date', models.DateField()),
                ('post_operation_management', models.CharField(default='', max_length=100, null=True, verbose_name='Post operation management')),
