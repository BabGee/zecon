# Generated by Django 3.1.3 on 2021-02-24 18:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('vet_form', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='portals.vet_forms')),
                ('farmer_mobile_number', models.CharField(default='', max_length=12, verbose_name='Farmer Mobile number')),
                ('date_of_birth', models.DateField(verbose_name='Date of birth')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Attach_photos_of_your_animal', models.ImageField(upload_to=None, verbose_name='Upload photos')),
                ('comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
