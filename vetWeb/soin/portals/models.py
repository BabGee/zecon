...
class Surgical_Approach_Form(models.Model):
	...
	post_management = models.CharField(max_length=100, default='',null=True,verbose_name='Post operation management')
...
class Artificial_Insemination_Form(models.Model):
	...
	sire_origin = models.CharField(max_length=200,null=True,blank=True,verbose_name='Sire`s origin')
	...
	reason_for_the_cause_of_abortion = models.CharField(max_length=100, null=True, blank=True,verbose_name='Reeason for the cause of abortion')
